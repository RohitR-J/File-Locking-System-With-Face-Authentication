...
protoPath = "face_detection_model/architecture.txt"
modelPath = "face_detection_model/weights.caffemodel"
...
for (i, imagePath) in enumerate(imagePaths):
    ...
    if len(detections) > 0:
        ...
        if confidence > 0.5:
            ...
            if fW >= 20 and fH >= 20:  # Change the condition to accept larger faces
